...
dataset=${2} # "abcd", "multi_woz", "taskmaster3"
ngpu=${3} # 1, 4

model="gpt2-medium"
model_path_tf="save/2301/${model}-${dataset}/${dataset}-${model}-tf-lr1e-4-bs4-epoch10-ws0-gas1-4gpu"

save_dir="save/2301/${model}-${dataset}/subsample/"
data_prefix="data/${dataset}/rl/${model}/subsample/${method}/"
